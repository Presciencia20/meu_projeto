...
<?php $this->section('title'); ?>Estatísticas: users - CasaSegura Admin<?php $this->endSection(); ?>
...
<div class="admin-layout">
    ...
    <main class="admin-main">
        <h2 style="font-weight: 800; font-family: 'Outfit';">Estatísticas: <?= ucfirst('users') ?></h2>
