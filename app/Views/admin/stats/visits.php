...
<?php $this->section('title'); ?>Estatísticas: visits - CasaSegura Admin<?php $this->endSection(); ?>
...
<div class="admin-layout">
    ...
    <main class="admin-main">
        <h2 style="font-weight: 800; font-family: 'Outfit';">Estatísticas: <?= ucfirst('visits') ?></h2>
