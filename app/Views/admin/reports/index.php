...
<?php $this->section('title'); ?>Denúncias - CasaSegura Admin<?php $this->endSection(); ?>
...
<div class="admin-layout">
    ...
    <main class="admin-main">
        ...
        <div class="table-container" style="margin-top: 2rem; text-align: center; padding: 5rem;">
            <i class="ph-duotone ph-warning-circle" style="font-size: 4rem; color: #ef4444; opacity: 0.2; margin-bottom: 2rem; display: block;"></i>
            <h3 style="color: var(--gray-400);">Denúncias de Imóveis</h3>
