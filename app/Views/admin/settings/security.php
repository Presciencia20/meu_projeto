...
<?php $this->section('title'); ?>Configurações: security - CasaSegura Admin<?php $this->endSection(); ?>
...
<div class="admin-layout">
    ...
    <main class="admin-main">
        <h2 style="font-weight: 800; font-family: 'Outfit';">Configurações: <?= ucfirst('security') ?></h2>
