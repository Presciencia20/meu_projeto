...
<?php $this->section('title'); ?>Configurações: limits - CasaSegura Admin<?php $this->endSection(); ?>
...
<div class="admin-layout">
    ...
    <main class="admin-main">
        <h2 style="font-weight: 800; font-family: 'Outfit';">Configurações: <?= ucfirst('limits') ?></h2>
